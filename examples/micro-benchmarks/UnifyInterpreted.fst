 ...
 * need for SMT simply by unfolding `by_smt` into its definition, but
...
assume val l : lock r (fun m -> by_smt (non_neg_inv r m))

#set-options "--no_smt"

(* Requires proving that (non_neg_inv r) == (fun m -> by_smt (non_neg_inv r m)) *)
