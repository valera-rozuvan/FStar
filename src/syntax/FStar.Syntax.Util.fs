...
let tand    = fvar PC.and_lid (Delta_constant_at_level 2) None
let tor     = fvar PC.or_lid  (Delta_constant_at_level 2) None
...
let b2t_v   = fvar PC.b2t_lid (Delta_constant_at_level 2) None
let t_not   = fvar PC.not_lid (Delta_constant_at_level 2) None
// These are `True` and `False`, not the booleans
let t_false = fvar PC.false_lid (Delta_constant_at_level 1) None
let t_true  = fvar PC.true_lid  (Delta_constant_at_level 1) None
